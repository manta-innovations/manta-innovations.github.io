...
xx Image 2  ![post-thumb]({{site.baseurl}}/assets/images/blog/timestream/database_configuration.png){:class="img-fluid rounded float mx-auto mb-2" :height="auto" width="60%"}
...
xx Image 3 - ![post-thumb]({{site.baseurl}}/assets/images/blog/timestream/storage_types.png){:class="img-fluid rounded float mx-auto mb-2" :height="auto" width="60%"}
